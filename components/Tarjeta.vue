<template lang="">
    <article class="card h-[45vh] w-[22vw] border-2 rounded-[20px]  shadow-md">
        ...
        <div class="card-body flex  flex-col justify-center items-center ">
            <img class="h-[200px] w-[200px] mt-[-25%] border-[5px] border-white rounded-[50%] bg-white" src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/dream-world/117.svg" alt="imagen de vitoko">
